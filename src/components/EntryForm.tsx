      ...
      <div className="px-4 py-6 space-y-6 max-w-lg mx-auto">
        ...
        <div className="space-y-3">
          ...
          <div className="flex gap-2">
            ...
            <Button
              ...
              variant="outline"
              size="icon"
              className="h-12 w-12 shrink-0 bg-accent border-2 border-primary/30 hover:bg-accent/80 hover:border-primary/50"
        ...
        <div className="space-y-3">
          ...
          <Button
            ...
            variant="outline"
            className={`w-full h-24 border-dashed border-2 hover:bg-accent/50 ${
              containerImage ? "border-success/50 bg-success/5" : "border-primary/30 bg-accent"
            }`}
          ...
          >
            {isProcessingContainer ? (
              ...
              <div className="flex items-center gap-3">
                <div className="h-16 w-16 rounded-lg overflow-hidden bg-muted ring-2 ring-success/30">
        ...
        {!showSecondContainer ? (
          <Button
            ...
            className="w-full h-12 text-primary hover:text-primary border border-dashed border-primary/30 hover:border-primary/50 hover:bg-accent"
          >
